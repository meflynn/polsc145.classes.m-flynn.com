...
<p style="margin-top:-140px; margin-left:-100px;"/>

```{r northern-ireland, fig.height=6, fig.width=4, fig.align='center'}

map.ireland <- getData("GADM", country = "IRL", level = 0) |>  
  sf::st_as_sf()

map.uk <- getData("GADM", country = "GBR", level = 0) |> 
  sf::st_as_sf()

map.northernireland <- getData("GADM", country = "GBR", level = 1) |> 
  sf::st_as_sf() |> 
