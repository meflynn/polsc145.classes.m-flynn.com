...
update_geom_defaults("text", list(size = 4, family = "oswald", fontface = "plain", lineheight = 1))
...
<figure>
<img src="../images/russia-etf-screenshot.jpg", style="border: 4px solid #000000;">
</figure>
...
ruble <- historical_exchange_rates("RUB", to = "USD",
                          start_date = "2015-01-01", end_date = "2023-03-15") %>% 
  dplyr::rename(rate = 2)

ggplot(ruble, aes(x = date, y = rate)) +
  geom_line() +
  theme_flynn(base_family = "oswald", base_size = 11) +
  scale_x_date(breaks = seq(as.Date("2015-01-01"), as.Date("2023-04-01"), by = "1 years"), date_labels = "%b %Y") +
